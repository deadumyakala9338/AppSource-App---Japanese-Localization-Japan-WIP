#if AppSource
report 70658581 "G/L Register TJP"
#endif
#if OnPremise
report 99006 "G/L Register TJP"
#endif
{
    DefaultLayout = RDLC;
    RDLCLayout = 'TecturaJP/JapanLocalization/GLRegisterJP.rdlc';
    ...
    dataset
    {
        dataitem("G/L Register"; "G/L Register")
        {
            ...
            dataitem("G/L Entry"; "G/L Entry")
            {
                ...
                column(GLAcc_Name; AccDescription)
                {
                }
                ...
                begin
                    ...
                    if (GlobalLanguage = 1041) and (GLAccount."Name (Japanese) TJP" <> '') then
                        AccDescription := GLAccount."Name (Japanese) TJP";
    ...
    requestpage
    {
        ...
        layout
        {
            area(content)
            {
                ...
                {
                    Caption = 'Options';
                    field(RepShowDetails; ShowDetails)
                    {
                        ApplicationArea = Basic, Suite;
    ...
    begin
        ...
        //
        LanguageRec.SetRange("Windows Language ID", GlobalLanguage);
        if LanguageRec.FindFirst() = true then
            LangSel := LanguageRec.Code
        else
            LangSel := 'JPN';
    end;
