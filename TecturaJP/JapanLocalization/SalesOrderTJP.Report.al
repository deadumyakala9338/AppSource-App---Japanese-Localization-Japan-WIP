#if AppSource
report 70658594 "Sales - Order TJP"
#endif
#if OnPremise
report 99019 "Sales - Order TJP"
#endif
{
    RDLCLayout = 'TecturaJP/JapanLocalization/SalesOrderJP.rdlc';
    Caption = 'Sales - Order';
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem(Header; "Sales Header")
        {
            ...
            column(CompanyBankBranchNo_Lbl; CompanyBankBranchLbl)
            {
            }
            ...
            */   //2023.12.04 DHA
            ...
            column(DocumentNo_Lbl; OurOrderNoLbl)
            {
            }
            ...
            column(SalesPersonName; SalesPersonNameText)
            {
            }
            ...
            column(ExtDocNo_SalesHeader_Lbl; ExtDocNoLbl)
            {
            }
    ...
    requestpage
    {
        ...
        layout
        {
            area(content)
            {
                group(Options)
                {
                    ...
                    field(ReqArchiveDocument; ArchiveDocument)
                    {
                        ApplicationArea = Basic, Suite;
        ...
        begin
            ...
            ArchiveDocument := SalesReceivablesSetup."Archive Orders";
    ...
    var
        ...
        PromDelDateLbl: Label 'Promised Delivery Date';
        ...
        CompanyBankBranchLbl: Label 'Bank Branch';
    ...
    begin
        LogInteraction := SegManagement.FindInteractionTemplateCode(Enum::"Interaction Log Entry Document Type"::"Sales Ord. Cnfrmn.") <> ''; //2023.12.01 DHA
    end;
    ...
    begin
        ...
        FillNameValueTable(LeftHeader, OurOrderNoLbl, Header."No.");
        ...
        FillNameValueTable(LeftHeader, PromDelDateLbl, Format(Header."Promised Delivery Date"));
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterFillLeftHeader(var LeftHeader: Record "Name/Value Buffer"; SalesInvoiceHeader: Record "Sales Header")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterFillRightHeader(var RightHeader: Record "Name/Value Buffer"; SalesInvoiceHeader: Record "Sales Header")
    begin
    end;
}
