#if AppSource
report 70658578 "Collective Inv. Portrait TJP"
#endif
#if OnPremise
report 99003 "Collective Inv. Portrait TJP"
#endif
{
    DefaultLayout = RDLC;
    RDLCLayout = 'TecturaJP/JapanLocalization/CollectiveInvoicePortrait.rdlc';
        ...
        dataitem(CopyLoop; "Integer")
        {
            ...
            dataitem(Customer; Customer)
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(CompanyAddr5; CompanyInformation."Phone No.")
                    {
                    }
                    ...
                    dataitem(CurrencyLoop; "Integer")
                    {
                        ...
                        dataitem("Cust. Ledger Entry"; "Cust. Ledger Entry")
                        {
                            ...
                            column(BankDetails; CompanyInformation."Bank Name" + ' ' + CompanyInformation."Bank Branch No." + ' ' + CompanyInformation."Bank Account No.")
                            {
                            }
                            column(CompanyName; CompanyInformation."Bank Account Holder Name TJP")
                            {
                            }
