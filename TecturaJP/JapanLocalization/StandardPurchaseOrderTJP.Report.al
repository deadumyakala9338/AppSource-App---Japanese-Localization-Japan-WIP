#if AppSource
report 70658592 "Standard Purchase - Order TJP"
#endif
#if OnPremise
report 99017 "Standard Purchase - Order TJP"
#endif
{
    WordLayout = 'TecturaJP/JapanLocalization/StandardPurchaseOrderJP.docx';
    Caption = 'Purchase - Order (Word)';
    DefaultLayout = Word;
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            */   //2023.12.04 DHA
            ...
            column(CustomBuyFromAdd2; CustomBuyFromAdd2)
            {
            }
            column(CustomBuyFromAdd3; CustomBuyFromAdd3)
            {
            }
            column(CustomBuyFromAdd4; CustomBuyFromAdd4)
            {
            }
            ...
            column(BuyFromVendAddress2; "Buy-from Address 2")
            {
            }
            ...
            begin
                ...
                if "Buy-from Address 2" = '' then begin
                    CustomBuyFromAdd2 := "Buy-from Vendor Name";
                    CustomBuyFromAdd3 := "Buy-from Vendor Name 2";
                    CustomBuyFromAdd4 := '';
                end else begin
                    CustomBuyFromAdd2 := "Buy-from Address 2";
                    CustomBuyFromAdd3 := "Buy-from Vendor Name";
                    CustomBuyFromAdd4 := "Buy-from Vendor Name 2";
                end;
    ...
    var
        ...
        CustomBuyFromAdd2: Text[100];
        CustomBuyFromAdd3: Text[100];
        CustomBuyFromAdd4: Text[100];
        LangSel: Code[10];
        OutputNo: Integer;
        DimText: Text[120];
    ...
    begin
        LogInteraction := SegManagement.FindInteractionTemplateCode(Enum::"Interaction Log Entry Document Type"::"Purch. Ord.") <> ''; //2023.12.01 DHA
    end;
}
