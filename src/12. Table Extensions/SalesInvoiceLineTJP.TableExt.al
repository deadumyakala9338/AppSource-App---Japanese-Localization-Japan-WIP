#if AppSource
tableextension 70658602 "Sales Invoice Line TJP" extends "Sales Invoice Line"
{
    fields
    {
...
#if OnPremise
tableextension 99027 "Sales Invoice Line TJP" extends "Sales Invoice Line"
{
    fields
    {
        ...
        field(99021; "Sell-to Customer Name 2 TJP"; Text[100])
        {
            Caption = 'Sell-to Customer Name 2';
            DataClassification = CustomerContent;
        }
        field(99022; "Bill-to Name 2 TJP"; Text[100])
        {
            Caption = 'Bill-to Name 2';
            DataClassification = CustomerContent;
        }
